...
public class Ahorcado {
    ...
    private String letrasEnc[];

    public Ahorcado(String[] vector, int cantEncontradas, int cantJugadasMax, String[] letrasEnc) {
        this.vector = vector;
    ...
    public String[] getLetrasEnc() {
        return letrasEnc;
    }

    public void setLetrasEnc(String[] letrasEnc) {
        this.letrasEnc = letrasEnc;
    }
